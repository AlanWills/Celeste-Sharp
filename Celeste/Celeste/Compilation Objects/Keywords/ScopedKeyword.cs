...
namespace Celeste
{
    ...
    internal class ScopedKeyword : Keyword
    {
        public override void Compile(CompiledStatement parent, string token, LinkedList<string> tokens, LinkedList<string> lines)
        {
            ...
            if (!CelesteStack.CurrentScope.VariableExists(token))
            {
                ...
                Variable variable = CelesteStack.CurrentScope.AddLocalVariable(rhsOfKeyword);
            ...
            {
                Debug.Fail("Variable with the same name already exists in this scope");
            }
        }
    }
}