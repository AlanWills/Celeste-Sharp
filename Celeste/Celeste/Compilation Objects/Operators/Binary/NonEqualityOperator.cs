...
namespace Celeste
{
    ...
    internal class NonEqualityOperator : BinaryOperator
    {
        ...
        /// <summary>
        /// NonEquality should take precedence over assignment
        /// </summary>
        ...
        /// Then pushes the result of the inequality on to the top of the stack.
        /// </summary>
        public override void PerformOperation()
        {
            ...
            Debug.Assert(CelesteStack.StackSize >= 2, "Not enough elements on the stack for the non equality operator");
            ...
            // We then finally push the result of the non equality test onto the stack
