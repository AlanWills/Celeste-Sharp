...
namespace TestCeleste
{
    ...
    public class TestAndOperator : CelesteUnitTest
    {
        ...
        {
            CelesteScript script = RunScript("TestScripts\\Operators\\And\\TestAndOperatorAndNumbers.cel");
        ...
        {
            CelesteScript script = RunScript("TestScripts\\Operators\\And\\TestAndOperatorAndStrings.cel");
        ...
        {
            CelesteScript script = RunScript("TestScripts\\Operators\\And\\TestAndOperatorAndBools.cel");
        ...
        {
            CelesteScript script = RunScript("TestScripts\\Operators\\And\\TestAndOperatorAndReferences.cel");
