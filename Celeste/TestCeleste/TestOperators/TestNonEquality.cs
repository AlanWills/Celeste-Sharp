...
namespace TestCeleste
{
    ...
    public class TestNonEqualityOperator : CelesteUnitTest
    {
        ...
        {
            CelesteScript script = RunScript("TestScripts\\Operators\\NonEquality\\TestNonEqualityOperatorEquateNumbers.cel");
        ...
        {
            CelesteScript script = RunScript("TestScripts\\Operators\\NonEquality\\TestNonEqualityOperatorEquateStrings.cel");
        ...
        {
            CelesteScript script = RunScript("TestScripts\\Operators\\NonEquality\\TestNonEqualityOperatorEquateBools.cel");
        ...
        {
            CelesteScript script = RunScript("TestScripts\\Operators\\NonEquality\\TestNonEqualityOperatorEquateReferences.cel");
